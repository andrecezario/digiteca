...
public class MenuItemAltSenhaListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		alterarFrame.setLocation(400, 200);
		...
		BotaoAlterarSenha ouvinteAlterarSenha = new BotaoAlterarSenha(campoLogin, campoSenhaAntiga, campoNovaSenha,
				alterarFrame);
